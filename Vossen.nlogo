...
to seek_pair ;;hier zit nu een error in met distance
  ask foxes with [days-till-hatch = "x"] [
    let sex male
...
to kill_foxes
  ask foxes [
    ifelse(age < 305) [;;mortality rate in first 10 months is over 50%
      if (random 1000 < 2) [;;0,002 chance of death a day
        die
      ]
    ]
    [
